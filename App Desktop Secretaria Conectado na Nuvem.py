...
API_URL = "https://SEU-APP-NO-RENDER.onrender.com"  # Ex: https://achados-etec-api.onrender.com
    ...
    def cadastrar_item(self):
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                messagebox.showerror("Erro", "Falha ao cadastrar na API.")
        except Exception as e:
            messagebox.showerror("Erro de Conexão", f"Não foi possível conectar ao servidor remoto: {e}")
